...
!!! tip "매매법 이름(D3)은 꼭 채워 주세요"
    각 탭의 **D3 셀**에 적은 글자가 **매매법 이름**이 되고, [계정 설정](accounts.md)의 **🔗 시트에서 계정 자동 등록** 이 이 값을 읽어 계정을 만듭니다. **D3가 비어 있는 탭은 계정으로 등록되지 않습니다.**(대시보드 같은 보조 탭은 비워 두세요.)

    ![시트 D3 셀 - 매매법 이름](../img/sheet_d3.png)
